    ...
    <div class="front-page-content">
        <section id="banner-slide">
            <div class="slide-container">
                <div class="slides">
                    ...
                    <div class="slide fade">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/slide2.png" alt="Slide 2">
                    </div>
                    <div class="slide fade">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/slide3.png" alt="Slide 3">
                    </div>
                </div>
                <div class="dots">
                    <span class="dot"></span>
        ...
        <section id="categories">
            <div class="categories-container">
                ...
                foreach ($product_categories as $category) {
                    ...
                    echo do_shortcode('[products category="' . $category->slug . '" columns="4"]');
        ...
        <section id="final-banner">
            <div class="final-banner-container">
                ...
                echo '<img src="' . get_template_directory_uri() . '/assets/images/main/final-banner.png" alt="Final Banner">';
                ?>
            </div>
        </section>
    </div>
