...
<?php if (have_posts(***REMOVED******REMOVED*** : while (have_posts(***REMOVED******REMOVED*** : the_post(***REMOVED***; ?>
    <div class="breadcrumb">
        <?php woocommerce_breadcrumb(***REMOVED***; // Exibir o breadcrumb ?>
    </div>
    <div class="product-content">
        <div class="product-block">
            <div class="product-gallery">
                <?php woocommerce_show_product_images(***REMOVED***; ?>
            </div>
            <div class="product-details">
                <div class="card card--sticky">
                    <h1 class="product-title"><?php the_title(***REMOVED***; ?> <span><i class="fas fa-check"></i></span></h1>
                    <table>
                        <tbody>
                            <tr>
                                <th rowspan="2" class="label">Preço</th>
                                <td class="value"><?php woocommerce_template_single_price(***REMOVED***; ?></td>
                            <tr>
                    ...
                    <?php woocommerce_template_single_add_to_cart(***REMOVED***; ?>
                                ...
                                <tr class="details-wrapper">
                                    <th>
                                            ...
                                            <summary>
                                                <div class="summary-content">
                                                    <div class="installments-img">
                                                        <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/visa.png" alt="payment-methods">
                                                        <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/master.png" alt="payment-methods">
                                                        <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/amex.png" alt="payment-methods">
                                                        <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/diners.png" alt="payment-methods">
                                        ...
                                        <div class="summary-final-content">
                                            <div class="installments-img">
                                                            <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/boleto.png" alt="payment-methods">
                                                            <img src="<?php echo get_template_directory_uri(***REMOVED***; ?>/assets/images/footer/pix.png" alt="payment-methods">
                                            </div>
                                            <?php
                                                global $product;

                                                if ( $product->is_on_sale(***REMOVED*** ***REMOVED*** {
                                                    echo '<span id="final-price" class="woocommerce-Price-amount amount">' . wc_price( $product->get_sale_price(***REMOVED*** ***REMOVED*** . '</span>';
                                                } else {
                                                    echo '<span id="final-price" class="woocommerce-Price-amount amount">' . wc_price( $product->get_regular_price(***REMOVED*** ***REMOVED*** . '</span>';
                                                }
                                            ?>
            ...
            <div class="product-description">
                <?php
                    ...
                    $product = wc_get_product( get_the_ID(***REMOVED*** ***REMOVED***;
                    if ( $product->get_description(***REMOVED*** ***REMOVED*** {
                        echo '<div class="woocommerce-product-details__short-description">';
                        echo wpautop( do_shortcode( $product->get_description(***REMOVED*** ***REMOVED*** ***REMOVED***;
                        echo '</div>';
                    }
                ?>
            </div>
